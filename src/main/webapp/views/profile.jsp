                                                ...
                                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                                    ...
                                                    <div class="ml-auto d-flex align-items-center PgRight">
                                                        <div class="TrackingFilter">
                                                            <a href="/redplastering/admin/edit-profile" class="btn btn-primary"><i class="bi bi-pencil"></i>Edit Profile</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card card-statistics">
                                                    <div class="card-body">                                          
                                                        <div class="card-box profile-header">
                                                            <div class="SmallSection Single">
                                                                <div class="profile-view">
                                                                    <div class="row">
                                                                        <div class="col-lg-5 d-flex align-item-center">
                                                                            <div class="profile-img">
                                                                                <img class="avatar" src="/views/assets/images/avatar-2.jpg" alt="">
                                                                            </div>
                                                                            <div class="profile-info-left w-50 d-flex align-items-center">
                                                                                <h3 class="user-name m-t-0 mb-0">${adminDetail.name}</h3>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-7">
                                                                            <ul class="personal-info">
                                                                                <li>
                                                                                    ...
                                                                                    <span class="text"><a href="#">${adminDetail.mobile}</a></span>
                                                                                </li>
                                                                                <li>
                                                                                    <span class="title">Email:</span>
                                                                                    <span class="text"><a href="#">${adminDetail.email}</a></span>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
