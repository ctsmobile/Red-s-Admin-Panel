                                                ...
                                                <div class="card card-statistics">
                                                    <div class="card-body">
                                                        <div class="SmallSection Multi">
                                                            <form action="/redplastering/admin/addLocation">
                                                                <div class="row form-group">
                                                                    <div class="col-md-6">
                                                                        <label>Job Site</label>
                                                                        <input type="text" class="form-control" name="jobSite" required>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label>Range <small>(Miles)</small> </label>
                                                                        <input type="number" min="0.06" class="form-control" name="range" step=".01" required>
                                                                    </div>
                                                                </div>
                                                                <div class="row form-group">
                                                                                                                                    <div class="col-md-6">
                                                                                                                                        <label>Project Number</label>
                                                                                                                                        <input type="number" class="form-control" name="projectNumber" required>
                                                                                                                                    </div>
                                                                                                                                    <div class="col-md-6">
                                                                                                                                        <label>Project Name</label>
                                                                                                                                        <input type="text" min="0" class="form-control" name="projectName" required>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                <div class="row form-group">
                                                                    <div class="col-md-12">
