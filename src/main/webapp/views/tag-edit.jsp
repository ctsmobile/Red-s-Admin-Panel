                                                ...
                                                <div class="card card-statistics">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="SmallSection">
                                                            <form action="/redplastering/admin/updateTag/${tagDetail.id}">
                                                                <div class="form-group">
                                                                    <label>Tag Name</label>
                                                                    <input type="text" class="form-control" value="${tagDetail.tagName}" name="tagName" required>
                                                                    <h6 style="color: red" id="message">${errorMessage}</h6>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Task</label>
                                                                    <textarea class="form-control" name="task" required>${tagDetail.task}</textarea>
                                                                </div>
