...
<body>
                                                ...
                                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                                    ...
                                                    <div class="ml-auto d-flex align-items-center PgRight">
                                                        <div class="TrackingFilter">
                                                            <a href="/redplastering/admin/dashboard" class="btn btn-primary"><i class="bi bi-arrow-left"></i>Back</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body TrackingWrapper">                                           
                                                        <div class="SmallSection">
                                                           <h6 style="color:red" id="message">${errorMessage}</h6>
                                                            <form action="/redplastering/admin/resetPassword">
                                                                <div class="form-group CurrentPass">
                                                                    <label class="bmd-label-floating">Current Password</label>
                                                                    <input type="password" id="password-field1" class="form-control" name="oldPassword" required>
                                                                    <span><i id="pass-status1" class="fa fa-eye" aria-hidden="true" onClick="currentPassword()"></i></span>
                                                                </div>
                                                                <div class="form-group CurrentPass">
                                                                    <label class="bmd-label-floating">New Password</label>
                                                                    <input type="password" id="password-field2" class="form-control" name="newPassword" required>
                                                                    <span><i id="pass-status2" class="fa fa-eye" aria-hidden="true" onClick="newPassword()"></i></span>
                                                                </div>
                                                                <div class="form-group CurrentPass" id="errorDiv">
                                                                    <label class="bmd-label-floating">Confirm Password</label>
                                                                    <input type="password" id="password-field3" class="form-control" onkeyup="checkPassword()" required>
                                                                    <span><i id="pass-status3" class="fa fa-eye" aria-hidden="true" onClick="confirmPassword()"></i></span>
                                                                </div>
                                                                <h6 style="color:red" id="error"></h6>

                                                                <div class="Btnwrapp text-center">
    ...
    <script>
        ...
        function checkPassword(){
            var password = document.getElementById('password-field2').value;
            var confirmPassword = document.getElementById('password-field3').value;
            var errorDiv = document.getElementById('error');
            console.log(password);
            var errorMessage = "Password didn't match";
