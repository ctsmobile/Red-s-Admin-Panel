                            ...
                            <div class="app-container">                                
                                <div class="app-main" id="main">
                                    <div class="container-fluid">
                                        <div class="row">
                                        <h6 style="color:green" id="message1">${successMessage}</h6>
                                            <div class="col-md-12 mb-4">
                                                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                                                    ...
                                                    <div class="ml-auto d-flex align-items-center PgRight">
                                                        <a href="/redplastering/admin/add-job" class="btn btn-primary"><i class="bi bi-plus"></i>Add Job</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="datatable-wrapper table-responsive">
                                                            <table id="datatable" class="display compact table table-striped table-bordered">
                                                                ...
                                                                <tbody>
                                                               <c:forEach items="${jobList}" var="element" varStatus="counter">

                                                                    <tr>
                                                                        <td>${counter.count}</td>
                                                                        <td>${element.jobName}</td>
                                                                        <td class="PicBox"><img src="${element.imageName}"></td>
                                                                        <td class="ActionBox">
                                                                            <a href="/redplastering/admin/editJob/${element.jobId}" class="btn btn-sm btn-primary">
                                                                                <span class="tooltiptext">Edit</span>
                                                                                <i class="bi bi-pencil"></i>
                                                                            </a>
                                                                            <a href="javascript:void();" class="btn btn-sm btn-primary"  data-toggle="modal" data-target="#DeleteModal" onclick="deleteTag(${element.jobId})">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-body text-center">
            ...
            <h4 class="pt-4">Are you sure you want to delete this Job?</h4>
            <div class="m-t-20"> 
...
var message = document.getElementById('successMessage').value;
  		...
  		console.log(token);
  			$.ajax({
  				url : "http://54.82.200.45:8082/api/v1/admin/deleteJobTypeById/" + id,
  				type : "delete",
  				headers : {
  				'token':token
  				},
