                                                ...
                                                <div class="card card-statistics">
                                                    <div class="card-body">
                                                        <div class="SmallSection Multi">
                                                            <form action="/redplastering/admin/updateEmployee/${employee.employeeId}">
                                                                ...
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control" value="${employee.phoneNo}" name="phoneNo">
                                                                    </div>
                                                                </div>                                                               
                                                                <div class="row form-group">
                                                                    <div class="col-md-6">
                                                                ...
                                                                <div class="row form-group">
                                                                    <div class="col-md-6">
                                                                        <label>Foreman</label>
                                                                        <input type="text" class="form-control" value="${employee.foreman}" name="foreman">
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <label>Rate of Pay</label>
                                                                        <input type="text" class="form-control" value="$ ${employee.rateOfPay}" name="rateOfPay">
                                                                    </div>
                                                                </div>                                                               
                                                                <div class="row form-group">
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control" value="${employee.deviceId}" name="deviceId">
                                                                    </div>
                                                                </div>                                                               
                                                                <div class="row form-group">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <select class="form-control" name="tags">
                                                                            ...
                                                                            <c:if test = "${element.tagName == employee.tags}">
                                                                                <option value='${element.tagName}' selected>${element.tagName}</option>
                                                                            </c:if>
                                                                            <c:if test = "${element.tagName != employee.tags}">
