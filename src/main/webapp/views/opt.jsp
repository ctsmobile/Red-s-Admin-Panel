        ...
        <div class="auth-content">
            ...
            <div class="card border-radius-0">
                <div class="card-body">
                    ...
                    <form action="creat-password.jsp">
                        <h3 class="mb-4">Enter One Time Password (otp 4digit)</h3>
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" placeholder="Enter otp...">
                        </div>               
                        <div class="LoginBtnBox">
                            <p class="mb-0 text-muted LeftBox"><a href="login.jsp"><i class="bi bi-arrow-left"></i> Back</a></p>
                            <button class="btn btn-primary mb-4 shadow-2 RightBox">Send <i class="feather icon-corner-up-right"></i></button>
                        </div>
                    </form>
                </div>
            </div>
